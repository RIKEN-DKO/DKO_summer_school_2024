ENDPOINT_T_BOX_URL = "https://metadb.riken.jp/metadb/sparql"
DATABASE = "http://metadb.riken.jp/db/riken_brc_cell" #MEdium 
# DATABASE = "http://metadb.riken.jp/db/Glycomics_mouse" #Supersmall
# DATABASE = "http://metadb.riken.jp/db/rikenbrc_mouse" #
# DATABASE = "http://metadb.riken.jp/db/riken_brc_animal" # Big 

# DATABASE = "http://metadb.riken.jp/db/clstMultimodalImage"
# DATABASE = "http://metadb.riken.jp/db/fantom5"

# ENDPOINT_T_BOX_URL = "https://www.bgee.org/sparql/"#NOpe
# ENDPOINT_T_BOX_URL = "https://ld.cultural.jp/sparql"
# ENDPOINT_T_BOX_URL = "http://localhost:3030/onto_example/sparql"
...
LIMIT_BY_PROPERTY = 1 # -1 # Maximum number of triple for each property in the prefetch step to retrieve the the relevant triples for the selected resource. Set -1 for retrieve all values for each property
...
INDEX_A_BOX = "FAISS" # Value "FAISS": Index based in vector distance using langchain.faiss; "WHOOSH": Index based in text similarity using whoosh; "SPOTLIGHT"
